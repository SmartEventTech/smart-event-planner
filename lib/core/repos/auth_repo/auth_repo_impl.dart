...
class AuthRepoImplementation implements AuthRepo {
  ...
  Future<Either<Failure, UserEntity>> createUserWithEmailAndPassword({
    ...
    try {
      ...
      logger.e('Unexpected registration error',
          error: e, stackTrace: stackTrace);
      return Left(
          ServerFailure(message: 'Registration failed. Please try again.'));
    }
  }
  ...
  Future<Either<Failure, UserEntity>> signInWithEmailAndPassword({
    ...
    try {
      ...
      return Left(ServerFailure(message: 'Login failed. Please try again.'));
    }
  }
  ...
  Future<Either<Failure, UserEntity>> verifyUser({
    ...
    try {
      logger
          .d('Attempting to verify user: $email with code: $verificationCode');
      ...
      logger.e('Unexpected verification error',
          error: e, stackTrace: stackTrace);
